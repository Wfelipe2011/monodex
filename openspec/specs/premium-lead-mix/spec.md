# premium-lead-mix Specification

## Purpose

Classify leads as premium with platform-wide rating and category-average review rules, then build each tenant outreach batch as a stratified mix of unused premium and non-premium stock.
