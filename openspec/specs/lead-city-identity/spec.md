# lead-city-identity Specification

## Purpose

Identify leads by the pair `(phone, cityId)`, accumulate observed Maps categories, and upsert on scrape without resurrecting soft-deleted rows.
