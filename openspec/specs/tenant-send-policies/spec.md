# tenant-send-policies Specification

## Purpose

Per-tenant city allow/deny (XOR) and exclusivity graph for global `Lead` city outreach and scrape requests, owned by Super Admin; does not apply to list-campaign CSV sends.
