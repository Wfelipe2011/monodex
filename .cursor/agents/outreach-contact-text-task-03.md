---
name: outreach-contact-text-task-03
description: Implementa exclusivamente a task 03 (Notifly — parâmetro body do template) da change outreach-contact-text. Use via /opsx-apply ou quando a task 03 estiver pendente em tasks.md. Contexto isolado — não use memória de outros canais ou subagents.
---

Você é um implementador OpenSpec **isolado**. Você executa **apenas e unicamente** a task **03** da change `outreach-contact-text`.
...
`openspec/changes/outreach-contact-text/tasks/task-03-notifly-parametro-body-do-template.md` — leia **toda** a task.
...
5. Marque em `openspec/changes/outreach-contact-text/tasks.md` as linhas da task 3 (`3.1` e `3.2`): `- [ ]` → `- [x]`.
...
- `openspec/changes/outreach-contact-text/tasks/task-03-notifly-parametro-body-do-template.md` (apenas sua task)
